...
- [x] Task: Implement file-based sprint store
  ...
  - Implement `FileSprintStore` reading/writing `conductor/sprints.json`.
...
- [x] Task: Update `conductor/tracks/sprint_management_20260330/plan.md` with completion status
