...
- [x] Task: Define issue output format specification
  ...
  - Add format spec to `conductor/workflow.md` or a new `conductor/agent-output-format.md`.
...
- [x] Task: Update `conductor/tracks/agent_issue_autocreation_20260330/plan.md` with completion status
