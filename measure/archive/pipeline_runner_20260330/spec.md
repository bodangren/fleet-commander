...
- **FR1**: Pipeline definition format in `measure/pipelines.yml` supporting stages, steps, commands, and conditional execution.
...
1. A valid `measure/pipelines.yml` is parsed without errors and the schema is validated on load.
