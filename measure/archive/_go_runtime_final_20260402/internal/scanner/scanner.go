...
// contain a "measure/" subdirectory. Recursion depth is limited to maxDepth.
...
func findProjects(dir string, depth int, results *[]string) {
	...
	for _, entry := range entries {
		...
		if name == "measure" {
			// The parent directory is a measure project
			*results = append(*results, dir)
			continue // don't recurse into the measure/ dir, but keep scanning siblings
		}
