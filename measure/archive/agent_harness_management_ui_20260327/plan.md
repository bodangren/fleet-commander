...
- [x] Task: Implement `HarnessStore` service with layered resolution (bundled defaults fallback, user-global `~/.measure/harnesses/` overrides).
...
- [x] Task: Implement `AgentStore` with three-layer resolution (bundled → user-global `~/.measure/agents/` → per-project `measure/agents/`).
...
- [x] Task: Measure — User Manual Verification 'Agent List View' (Protocol in workflow.md)
...
- [x] Task: Measure — User Manual Verification 'Agent Editor' (Protocol in workflow.md)
...
- [x] Task: Measure — User Manual Verification 'Harness Management UI' (Protocol in workflow.md)
...
- [x] Task: Measure — User Manual Verification 'Agent Dry Run' (Protocol in workflow.md)
