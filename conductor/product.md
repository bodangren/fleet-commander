...
Conductor Fleet Commander is a local-first orchestration control plane built on **Bun + Convex**.
...
- **Documentation Sync:** `conductor/` markdown in managed repos remains durable documentation and export/sync output, not the sole source of runtime truth.
...
- Managed project `conductor/` artifacts remain important for traceability and portability.
