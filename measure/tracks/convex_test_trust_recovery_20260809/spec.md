...
TD-263 is the test-trust recovery track for the Convex suite, which mixed registered Convex functions with direct handler calls and hand-built contexts. The implementation lanes repaired the exposed production contracts and moved the selected critical unsupported tests onto the `convex-test` JavaScript mock runtime with explicit identities. The track is **completed**: dirty-worktree and clean-checkout full gates pass, with separately owned warnings and follow-up debt explicitly classified.

The authoritative track baseline is **1,299 passed / 139 failed / 629 warnings**, captured for the 2026-08-09 recovery audit. The earlier scalpel closeout snapshot (**1,241 passed / 157 failed**) remains historical evidence at `measure/tracks/scalpel_branch_closeout_20260807/evidence/BASELINE.md`; it is not the baseline for this track. Clean-checkout closeout evidence is **21 runtime files / 105 tests passed**, **35 remaining Bun files / 957 tests passed / 0 failed**, frontend **173 files / 1,260 tests passed in 211.03s**, Pivot **150 files / 1,726 tests passed**, and passing Convex/Pivot typechecks. Frontend format/lint/tsc/build pass; the build produced 2,803 modules with an existing >500k advisory. The 23 notification-only wrapper warnings and frontend's 59 legacy React `act` warnings plus one duplicate-key warning are explicitly classified as separate follow-up debt, not TD-263 failures. Employees/runs/scheduler/unused UI and hook cleanup remains deferred to TD-247. Real Chrome aggregate evidence is **3 passed / 1 approval-gated skipped in 1.2m**.
...
- The final TD-263 Convex gate runs the complete discovered suite with `VERIFY_REQUIRE_CONVEX=1` semantics and no quarantine escape. Dirty-worktree and clean-checkout runtime, Bun, Pivot, frontend, typecheck, format/lint/build evidence is green; separately classified notification/frontend warnings do not belong to TD-263 acceptance.
...
6. Dirty-worktree and clean-checkout runtime, Bun, Pivot, frontend, typecheck, frontend format/lint/tsc/build gates are green: runtime 21 files / 105 passed, Bun 35 files / 957 passed / 0 failed, frontend 173 files / 1,260 passed in 211.03s, and Pivot 150 files / 1,726 passed. The 23 notification wrappers and 60 frontend warnings are separately classified follow-up debt, not TD-263 failures; no TD-263-owned failures, errors, or unclassified warnings remain.
...
8. The plan records focused evidence, dirty-worktree and clean-checkout gate evidence, the warning ledger, browser proof, Doctor findings, graph evidence, bootstrap-coupling follow-up, and the final **completed** TD-263 status.
