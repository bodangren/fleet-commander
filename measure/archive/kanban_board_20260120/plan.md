# Implementation Plan - Kanban Board from Measure + Git

## Phase 1: Data Model and Measure Parsing [checkpoint: 2f99eb2]
Define the core board data structures and parse Measure files into normalized tasks.
...
- [x] Task: Parse measure/tracks.md for track list and status 2081edb
    - [x] Write unit tests for tracks.md parsing
    - [x] Implement tracks.md parser
- [x] Task: Parse measure/tracks/<track_id>/plan.md for phases and tasks ab838b4
    - [x] Write unit tests for plan.md parsing and phase/task association
    - [x] Implement plan.md parser
- [x] Task: Measure - User Manual Verification 'Phase 1: Data Model and Measure Parsing' (Protocol in workflow.md) 2f99eb2
...
- [x] Task: Measure - User Manual Verification 'Phase 2: IPC, Project Selection, and Refresh (Dogfood MVP)' (Protocol in workflow.md) f330e80
...
- [x] Task: Measure - User Manual Verification 'Phase 3: Board UI (Dogfood MVP)' (Protocol in workflow.md) 4d0abf0
...
- [x] Task: Measure - User Manual Verification 'Phase 4: Git Enrichment and Inference' (Protocol in workflow.md) 953c74b

## Phase 5: File Updates and Drag-and-Drop [checkpoint: 73d829c]
Support moving tasks between columns and persisting the status to Measure files.

- [x] Task: Update Measure files when task status changes 808999f
...
- [x] Task: Measure - User Manual Verification 'Phase 5: File Updates and Drag-and-Drop' (Protocol in workflow.md) 73d829c
