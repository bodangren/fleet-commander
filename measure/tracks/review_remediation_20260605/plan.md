...
- [x] Task: Reproduce the 4 red tests; determine whether the BurnForecastCard render bug is in the component or whether the tests encode a stale projectId contract.
