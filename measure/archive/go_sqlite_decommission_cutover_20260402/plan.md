...
- [x] Task: Verify prerequisite parity tracks have passed acceptance gates
  - Sub-item: Frontend Convex migration complete (archived at measure/archive/frontend_convex_migration_20260402/)
  - Sub-item: Bun orchestrator migration complete (archived at measure/archive/bun_orchestrator_migration_20260402/)
...
- [x] Task: Freeze decommission scope with explicit include/exclude module list
  ...
  - Evidence: `measure/tracks/go_sqlite_decommission_cutover_20260402/decommission-scope.md`
...
- [x] Task: Publish operator cutover checklist and rollback trigger thresholds
  ...
  - Evidence: `measure/tracks/go_sqlite_decommission_cutover_20260402/operator-checklist.md`
...
- [x] Task: Remove or archive superseded Go/SQLite modules for migrated slices
  ...
  - Evidence: Archived `internal/analysis`, `internal/coverage`, `internal/harnesses` to `measure/archive/_superseded_go_modules_20260402/`
- [x] Task: Remove obsolete runtime wiring and docs references
  - Sub-item: Ensure `measure/*` and root docs represent Bun + Convex steady state
  - Evidence: `measure/tracks/go_sqlite_decommission_cutover_20260402/decommission-scope.md` documents retain/archive decisions
