...
- [x] Task: Measure - User Manual Verification 'Phase 1: Scheduling Data Model & Persistence'
...
- [x] Task: Measure - User Manual Verification 'Phase 2: Scheduler Service'
...
- [x] Task: Measure - User Manual Verification 'Phase 3: UI for Scheduling Controls'
