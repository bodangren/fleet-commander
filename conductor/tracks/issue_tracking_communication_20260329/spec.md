...
Issue Tracking enables agents to create structured Issue files during execution to report blockers, spawn sub-tasks, or request help from other personas. Issues are stored as Markdown files in conductor/issues/.
...
### FR2: Issue Storage
- Store in conductor/issues/{project_id}/
- File format: {issue-id}.md with YAML frontmatter
- Index in conductor/tracks.md issues section
