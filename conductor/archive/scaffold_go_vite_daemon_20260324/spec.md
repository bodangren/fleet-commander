...
## Overview
Initialize the completely new architecture for Conductor Fleet Commander. We are moving from a single-project React/Electron app to a multi-project Go daemon that serves a Vite/React frontend.
