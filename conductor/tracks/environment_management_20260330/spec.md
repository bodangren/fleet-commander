...
- **FR2**: Environment configuration stored in `conductor/environments.yml` with schema validation.
...
1. `conductor/environments.yml` with two environments (staging, production) loads without validation errors.
