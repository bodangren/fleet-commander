...
1. Archive dead code packages:
   ```
   mkdir -p conductor/archive/_superseded_go_modules_20260402
   mv internal/analysis conductor/archive/_superseded_go_modules_20260402/
   mv internal/coverage conductor/archive/_superseded_go_modules_20260402/
   mv internal/harnesses conductor/archive/_superseded_go_modules_20260402/
   ```
...
```bash
mv conductor/archive/_superseded_go_modules_20260402/analysis internal/
mv conductor/archive/_superseded_go_modules_20260402/coverage internal/
mv conductor/archive/_superseded_go_modules_20260402/harnesses internal/
```
