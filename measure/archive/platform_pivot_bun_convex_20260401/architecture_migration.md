...
- `measure/` markdown artifacts are synchronized documentation outputs, not the only runtime database.
...
- `measure/tracks/*.md` / `plan.md` / `spec.md`
- `measure/broker/open|resolved/*.md`
- `measure/logs/**/*.jsonl`
