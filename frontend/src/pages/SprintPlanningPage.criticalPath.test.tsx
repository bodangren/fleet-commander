...
function buildChainRecommendation() {
  ...
  return {
    tasks: [
      {
        taskId: 't1', taskTitle: 'T1', storyPoints: 2, priority: 'medium',
        assignedAgentId: 'a1', assignedAgentName: 'Alice', agentRole: 'architect',
        costPerPoint: 4.2, estimatedCost: 8.4, selected: true,
      },
      {
        taskId: 't2', taskTitle: 'T2', storyPoints: 8, priority: 'medium',
        assignedAgentId: 'a1', assignedAgentName: 'Alice', agentRole: 'architect',
        costPerPoint: 4.2, estimatedCost: 33.6, selected: true,
      },
      {
        taskId: 't3', taskTitle: 'T3', storyPoints: 3, priority: 'medium',
        assignedAgentId: 'a2', assignedAgentName: 'Bob', agentRole: 'executor',
        costPerPoint: 2.1, estimatedCost: 6.3, selected: true,
      },
      {
        taskId: 't4', taskTitle: 'T4', storyPoints: 1, priority: 'medium',
        assignedAgentId: 'a2', assignedAgentName: 'Bob', agentRole: 'executor',
        costPerPoint: 2.1, estimatedCost: 2.1, selected: true,
      },
    ],
    agentBreakdown: [],
    totalPoints: 14,
