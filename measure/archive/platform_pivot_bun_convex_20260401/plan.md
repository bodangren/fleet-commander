...
- [x] Task: Update `measure/product.md`, `measure/tech-stack.md`, and conflicting roadmap/workflow language to describe the Bun + Convex target architecture
  - Evidence: `measure/product.md`, `measure/tech-stack.md`, `measure/tracks.md`, `measure/workflow.md`
- [x] Task: Write a migration architecture note mapping current Go/SQLite modules to planned Bun/Convex replacements
  - Evidence: `measure/tracks/platform_pivot_bun_convex_20260401/architecture_migration.md`
...
- [x] Task: Add Convex to project and establish initial local development workflow
  - Evidence: `convex/` schema/functions, generated files under `convex/_generated`, workflow commands in `measure/tech-stack.md`
