...
| TD-267 | Pi roster drift: the seeded `intern` names retired `kimi-for-coding/kimi-for-coding-highspeed`, leaving two readiness failures; replace it with installed-harness `openai/gpt-5.6-luna`, remove the retired checked-in served entry, and align active intern/org-chart docs. | High | `agent_harness_roster_recovery_20260809` |
